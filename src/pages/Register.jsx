...
export default function Register() {
    return (
        <>
            ...
            <div className="flex bg-gray-200 w-full h-[100vh] rounded-b-lg">
                ...
                <div className="flex flex-row justify-around items-center w-[840px] h-[900px] top-[11px] left-[493px] bg-gray-200">
                    <div className="w-[578px] h-[669px] top-[96px] left-[731px] border-0 absolute">
                        ...
                        <form className="relative space-y-4">
                            ...
                            <label htmlFor="" className="font-sans font-normal text-base items-center leading-[100%] w-[578px] h-[19px] tracking-tight ">YOUR E-MAIL</label>
                            <input type="email" placeholder="Enter your name" className="flex w-[578px] h-[46px] p-[10px] border  border-gray-200 bg-white rounded-[5px] gap-[10px]" />
