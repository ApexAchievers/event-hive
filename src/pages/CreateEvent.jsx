      ...
      <section className="bg-gray-50 flex items-center justify-center min-h-screen">
        <div className="max-w-4xl w-full mx-auto px-6 py-12 bg-white shadow-md rounded-lg">
          ...
          <form action={postEvent} className="space-y-8">
            ...
            <div className="mb-4 grid grid-cols-1 md:grid-cols-2 gap-6"></div>
            ...
            <div className="mb-4">
              ...
              <input
                ...
                name="description"
                id="text"
                className="w-full h-35 px-4 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500"
              />
            ...
            <div className="mb-4">
              <SubmitButton
                className=" w-full bg-primary text-white font-semibold py-3 px-8 rounded-md hover:bg-purple-500 cursor-pointer transition duration-200"
                title={"Create event"}
              />
            </div>
          </form>
