        ...
        <div className="text-gray-800 bg-gray-50">
            ...
            <section className="relative w-[90%] mx-auto">
                ...
                <div className="flex flex-col justify-center px-12 text-white">
                    <button className="mb-10 flex item-center font-medium mt-1 text-sm bg-primary px-4 py-1 rounded w-fit">&larr; Back</button>
                    <h2 className="text-4xl text-white font-bold mb-8">Dream world wide
                      <span className="block mt-3">in Jakatra</span>
                    </h2>
                    <p className="text-xl mb-2 font-semibold mt-1">IIIT Sonepat</p>
                    ...
                    <a href="#" className="mt-4 inline-block text-white underline">View map</a>
                </div>
                ...
                <div className="bg-white text-black p-6 rounded shadow-lg w-64">
                    ...
                    <a href="#" className="text-sm text-primary mb-3 block">Add to calendar</a>
                    <button className="bg-primary text-white w-full py-2 rounded mb-2">Book now</button>
                    <button className="bg-gray-300 w-full py-2 rounded text-sm mb-1">Program promoter</button>
